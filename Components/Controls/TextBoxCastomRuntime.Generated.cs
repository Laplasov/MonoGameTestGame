//Code for Controls/TextBoxCastom (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class TextBoxCastomRuntime : ContainerRuntime
{
    [System.Runtime.CompilerServices.ModuleInitializer]
    public static void RegisterRuntimeType()
    {
        GumRuntime.ElementSaveExtensions.RegisterGueInstantiationType("Controls/TextBoxCastom", typeof(TextBoxCastomRuntime));
    }
    ...
    public TextBoxCastomRuntime(bool fullInstantiation = true, bool tryCreateFormsObject = true)
    {
        if(fullInstantiation)
        {
            var element = ObjectFinder.Self.GetElementSave("Controls/TextBoxCastom");
