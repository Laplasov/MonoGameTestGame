//Code for Controls/Window1 (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class Window1Runtime : ContainerRuntime
{
    [System.Runtime.CompilerServices.ModuleInitializer]
    public static void RegisterRuntimeType()
    {
        GumRuntime.ElementSaveExtensions.RegisterGueInstantiationType("Controls/Window1", typeof(Window1Runtime));
    }
    ...
    public Window1Runtime(bool fullInstantiation = true, bool tryCreateFormsObject = true)
    {
        if(fullInstantiation)
        {
            var element = ObjectFinder.Self.GetElementSave("Controls/Window1");
