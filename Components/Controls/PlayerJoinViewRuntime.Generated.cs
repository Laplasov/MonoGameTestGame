...
partial class PlayerJoinViewRuntime : ContainerRuntime
{
    ...
    public override void AfterFullCreation()
    {
        ...
        PlayerJoinViewItem1 = this.GetGraphicalUiElementByName("PlayerJoinViewItem1") as Project1.Components.Controls.PlayerJoinViewItemRuntime;
        PlayerJoinViewItem2 = this.GetGraphicalUiElementByName("PlayerJoinViewItem2") as Project1.Components.Controls.PlayerJoinViewItemRuntime;
        PlayerJoinViewItem3 = this.GetGraphicalUiElementByName("PlayerJoinViewItem3") as Project1.Components.Controls.PlayerJoinViewItemRuntime;
        PlayerJoinViewItem4 = this.GetGraphicalUiElementByName("PlayerJoinViewItem4") as Project1.Components.Controls.PlayerJoinViewItemRuntime;
        CustomInitialize();
    }
