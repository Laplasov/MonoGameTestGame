...
partial class InputDeviceSelectorRuntime : ContainerRuntime
{
    ...
    public override void AfterFullCreation()
    {
        ...
        InputDeviceSelectionItemInstance = this.GetGraphicalUiElementByName("InputDeviceSelectionItemInstance") as Project1.Components.Controls.InputDeviceSelectionItemRuntime;
        InputDeviceSelectionItemInstance1 = this.GetGraphicalUiElementByName("InputDeviceSelectionItemInstance1") as Project1.Components.Controls.InputDeviceSelectionItemRuntime;
        InputDeviceSelectionItemInstance2 = this.GetGraphicalUiElementByName("InputDeviceSelectionItemInstance2") as Project1.Components.Controls.InputDeviceSelectionItemRuntime;
        InputDeviceSelectionItemInstance3 = this.GetGraphicalUiElementByName("InputDeviceSelectionItemInstance3") as Project1.Components.Controls.InputDeviceSelectionItemRuntime;
        CustomInitialize();
    }
