...
partial class ScrollViewerRuntime : ContainerRuntime
{
    ...
    public override void AfterFullCreation()
    {
        ...
        VerticalScrollBarInstance = this.GetGraphicalUiElementByName("VerticalScrollBarInstance") as Project1.Components.Controls.ScrollBarRuntime;
        HorizontalScrollBarInstance = this.GetGraphicalUiElementByName("HorizontalScrollBarInstance") as Project1.Components.Controls.ScrollBarRuntime;
