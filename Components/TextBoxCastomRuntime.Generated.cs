//Code for TextBoxCastom (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class TextBoxCastomRuntime : ContainerRuntime
{
    ...
    {
        GumRuntime.ElementSaveExtensions.RegisterGueInstantiationType("TextBoxCastom", typeof(TextBoxCastomRuntime));
    }
    ...
    public TextBoxCastomRuntime(bool fullInstantiation = true, bool tryCreateFormsObject = true)
    {
        ...
        {
            var element = ObjectFinder.Self.GetElementSave("TextBoxCastom");
