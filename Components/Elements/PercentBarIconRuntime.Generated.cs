...
namespace Project1.Components.Elements;
partial class PercentBarIconRuntime : ContainerRuntime
{
    ...
    public override void AfterFullCreation()
    {
        ...
        CautionLinesInstance = this.GetGraphicalUiElementByName("CautionLinesInstance") as Project1.Components.Elements.CautionLinesRuntime;
        VerticalLinesInstance = this.GetGraphicalUiElementByName("VerticalLinesInstance") as Project1.Components.Elements.VerticalLinesRuntime;
        CustomInitialize();
    }
