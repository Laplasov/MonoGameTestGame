//Code for Castom/ListBoxNewCastom (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class ListBoxNewCastom : global::Gum.Forms.Controls.ListBox
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Castom/ListBoxNewCastom");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named Castom/ListBoxNewCastom - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new ListBoxNewCastom(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(ListBoxNewCastom)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Castom/ListBoxNewCastom", () => 
        {
    ...
    public ListBoxNewCastom(InteractiveGue visual) : base(visual)
    {
    }
    public ListBoxNewCastom()
    {
