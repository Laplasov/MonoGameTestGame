...
partial class ScrollBarNewCastom : global::Gum.Forms.Controls.ScrollBar
{
...
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named Castom/ScrollBarNewCastom - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new ScrollBarNewCastom(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(ScrollBarNewCastom)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Castom/ScrollBarNewCastom", () => 
        {
    ...
    public ScrollBarNewCastom(InteractiveGue visual) : base(visual)
    {
    }
    public ScrollBarNewCastom()
    {
