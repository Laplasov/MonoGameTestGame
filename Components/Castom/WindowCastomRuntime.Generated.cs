//Code for Castom/WindowCastom (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class WindowCastomRuntime : ContainerRuntime
{
    [System.Runtime.CompilerServices.ModuleInitializer]
    public static void RegisterRuntimeType()
    {
        GumRuntime.ElementSaveExtensions.RegisterGueInstantiationType("Castom/WindowCastom", typeof(WindowCastomRuntime));
    }
    ...
    public WindowCastomRuntime(bool fullInstantiation = true, bool tryCreateFormsObject = true)
    {
