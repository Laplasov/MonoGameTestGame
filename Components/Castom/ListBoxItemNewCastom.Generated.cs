//Code for Castom/ListBoxItemNewCastom (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class ListBoxItemNewCastom : global::Gum.Forms.Controls.ListBoxItem
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Castom/ListBoxItemNewCastom");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named Castom/ListBoxItemNewCastom - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new ListBoxItemNewCastom(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(ListBoxItemNewCastom)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Castom/ListBoxItemNewCastom", () => 
        {
    ...
    public ListBoxItemNewCastom(InteractiveGue visual) : base(visual)
    {
    }
    public ListBoxItemNewCastom()
    {
