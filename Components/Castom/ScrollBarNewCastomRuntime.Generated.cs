//Code for Castom/ScrollBarNewCastom (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class ScrollBarNewCastomRuntime : ContainerRuntime
{
    [System.Runtime.CompilerServices.ModuleInitializer]
    public static void RegisterRuntimeType()
    {
        GumRuntime.ElementSaveExtensions.RegisterGueInstantiationType("Castom/ScrollBarNewCastom", typeof(ScrollBarNewCastomRuntime));
    }
    ...
    public ScrollBarNewCastomRuntime(bool fullInstantiation = true, bool tryCreateFormsObject = true)
    {
        if(fullInstantiation)
        {
            var element = ObjectFinder.Self.GetElementSave("Castom/ScrollBarNewCastom");
    ...
    public override void AfterFullCreation()
    {
        ...
        UpButtonInstance = this.GetGraphicalUiElementByName("UpButtonInstance") as Project1.Components.Controls.ButtonIconRuntime;
        DownButtonInstance = this.GetGraphicalUiElementByName("DownButtonInstance") as Project1.Components.Controls.ButtonIconRuntime;
        ...
        ThumbInstance = this.GetGraphicalUiElementByName("ThumbInstance") as Project1.Components.Controls.ButtonStandardRuntime;
        CustomInitialize();
    }
