//Code for Castom/TextBoxCastomNew (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class TextBoxCastomNewRuntime : ContainerRuntime
{
    [System.Runtime.CompilerServices.ModuleInitializer]
    public static void RegisterRuntimeType()
    {
        GumRuntime.ElementSaveExtensions.RegisterGueInstantiationType("Castom/TextBoxCastomNew", typeof(TextBoxCastomNewRuntime));
    }
    ...
    public TextBoxCastomNewRuntime(bool fullInstantiation = true, bool tryCreateFormsObject = true)
    {
        if(fullInstantiation)
        {
            var element = ObjectFinder.Self.GetElementSave("Castom/TextBoxCastomNew");
