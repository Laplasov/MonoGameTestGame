//Code for Castom/Window1 (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class Window1Runtime : ContainerRuntime
{
    ...
    {
        GumRuntime.ElementSaveExtensions.RegisterGueInstantiationType("Castom/Window1", typeof(Window1Runtime));
    }
    ...
    public Window1Runtime(bool fullInstantiation = true, bool tryCreateFormsObject = true)
    {
        ...
        {
            var element = ObjectFinder.Self.GetElementSave("Castom/Window1");
