...
partial class TreeItemCastom : global::Gum.Forms.Controls.FrameworkElement
{
...
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named Castom/TreeItemCastom - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new TreeItemCastom(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(TreeItemCastom)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Castom/TreeItemCastom", () => 
        {
    ...
    public TreeItemCastom(InteractiveGue visual) : base(visual)
    {
    }
    public TreeItemCastom()
    {
